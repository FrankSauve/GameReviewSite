/**
 * Scores are half-points on a 1–10 scale. `validateRating` in
 * backend/src/resolvers/review.ts enforces it; these exist so the input cannot
 * offer a value the API would reject, not as a substitute for that check.
 */
